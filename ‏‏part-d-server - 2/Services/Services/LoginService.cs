    ...
    public class LoginService : ILoginService
    {
        ...
        public string GenerateToken(UserDto user)
        {
            ...
            var claims = new[]
            {
                ...
                new Claim(ClaimTypes.Role, user.IsOwner == true ? "owner" : "provider") 
            };
        ...
        {
            return _userService.GetAll().FirstOrDefault(u => u.Name == name && BCrypt.Net.BCrypt.Verify(pwd, u.Password));
        }
...
//    public class LoginService : ILoginService
//    {
//        private readonly IService<UserDto> _provService;
//        private readonly IService<OwnerDto> _ownerService;
//        private readonly IConfiguration _config;

//        public LoginService(IService<UserDto> provService, IService<OwnerDto> ownerService, IConfiguration config)
//        {
//            _provService = provService;
//            _ownerService = ownerService;
//            _config = config;
//        }
//        public string GenerateTokenP(UserDto prov)
//        {
//            //the code to encode in a bytes array
//            var secretKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_config["Jwt:Key"]));
//            //encoding
...
//        public UserDto VerifyP(string name, string pwd)
//        {
